...
namespace CodeInn
{
    ...
    public sealed partial class HubPage : Page
    {
        ...
        private void ItemView_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            else if (itemId == "Scratchpad" && !Frame.Navigate(typeof(CodeEditor), new CodeEditorContext(new Problems(0, "Scratchpad", "Code and run anything you want. Go ahead, try new things.", "I2luY2x1ZGUgPGlvc3RyZWFtPg0KDQp1c2luZyBuYW1lc3BhY2Ugc3RkOw0KDQppbnQgbWFpbigpIHsNCg0KCS8vIFR5cGUgeW91ciBjb2RlIGhlcmUNCg0KCXJldHVybiAwOw0KfQ0K", "Admin"), "Scratchpad")))
            {
                throw new Exception(this.resourceLoader.GetString("NavigationFailedExceptionMessage"));
            }
            ...
            else if (itemId == "Progress" && !Frame.Navigate(typeof(ProgressTracker), itemId))
            {
                throw new Exception(this.resourceLoader.GetString("NavigationFailedExceptionMessage"));
            }
        }
